...
public class TestAsignarPuntos {
  ...
  /*
   * @Test public void testMasDe200Puntos(){ Humano h = new Humano("Nicolas",new
   * Guerrero(),1); PaquetePersonajeDom pp = new PaquetePersonajeDom();
   * 
   * pp.setFuerza(199); pp.setDestreza(199); pp.setInteligencia(199);
   * pp.setCasta("Asesino"); h.actualizarEstado(pp); h.AsignarPuntosSkills(2, 2,
   * 2); Assert.assertEquals(h.getFuerza(),199);
