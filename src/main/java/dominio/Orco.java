...
/**
 * La clase "Orco" es un tipo de Personaje (por ende, hereda de esta misma).
...
public class Orco extends Personaje {
	...
	protected static final String[] habilidades = new String[] { "Golpe Defensa", "Mordisco de Vida" };
	...
	public Orco(final String nombre, final Asesino asesino, final int id) {
		super(nombre, asesino, id, AUMENTO_SALUD_TOPE_POR_RAZA, 0, "Orco", habilidades);
	}
	...
	// Golpe Defensa.
	/**
	 * El metodo "habilidadRaza1" correspondiente a la habilidad "Golpe Defensa"
	 * se ocupa de aplicar el doble de la defensa del atacante como daño.
	 */
	public boolean habilidadRaza1(final Peleable atacado) {
		if (this.getEnergia() > COSTE_DE_ENERGIA_HABILIDADES) {
			this.disminuirEnergia(COSTE_DE_ENERGIA_HABILIDADES);
			if (atacado.serAtacado(this.getDefensaTotal() * 2) > 0) {
				return true;
			}
		}
		return false;
	 ...
	 * "Mordisco de Vida" se ocupa de aplicar daño en funcion a la cantidad de
	 * fuerza del personaje. Si este daño se aplica el atacante se cura la misma
